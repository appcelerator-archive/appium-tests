...
class Helper {
	...
	*/
	...
	/*
		...
		@param {Function} done -
	*/
	static launchGeny(genyDevice, done) {
		/*
			NOTE: this will only work in macOS; need to find out a way to make this work on windows
			using ChildProcess:
				- run "VBoxManage list vms" to make sure genyDevice is added to genymotion app
				- run /Applications/Genymotion.app/Contents/MacOS/player.app/Contents/MacOS/player --vm-name "<genyDevice>"
					- this assumes that the genymotion app is installed in the default /Application directory
		*/
	}
